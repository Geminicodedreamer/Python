...
user = '1925959013@qq.com'
password = 'wangyubo20040617'
# step = ''
step = str(randint(60121, 89302))
...
def main():
    ...
    data = f'userid={
        userid}&last_sync_data_time=1597306380&device_type=0&last_deviceid=DA932FFFFE8816E7&data_json={data_json}'
